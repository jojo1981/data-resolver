 ...
 */
final class SomeExtractorTest extends TestCase
{
    use ProphecyTrait;
     ...
     * @throws ExtractorException
     */
    public function testExtractShouldReturnFalseWhenSequenceHandlerGetIteratorReturnAnEmptyIterator(): void
    {
     ...
     * @throws ExtractorException
     */
    public function testExtractShouldReturnTrueWhenAnItemIsMatchedByThePredicate(): void
    {
        $this->originalContext->getData()->willReturn('my-data')->shouldBeCalledTimes(2);
        $this->originalContext->getPath()->shouldNotBeCalled();
        /** @noinspection PhpUndefinedMethodInspection */
     ...
     * @throws ExtractorException
     */
    public function testExtractShouldReturnFalseWhenNoItemIsMatchedByThePredicate(): void
    {
        $this->originalContext->getData()->willReturn('my-data')->shouldBeCalledTimes(2);
        $this->originalContext->getPath()->shouldNotBeCalled();
        /** @noinspection PhpUndefinedMethodInspection */
