 ...
 */
final class AllExtractorTest extends TestCase
{
    use ProphecyTrait;
    ...
    public function testExtractShouldReturnTrueWhenSequenceHandlerGetIteratorReturnAnEmptyIterator(): void
    {
        ...
        self::assertTrue($this->getAllExtractor()->extract($this->originalContext->reveal()));
    }
     ...
     * @throws ExtractorException
     */
    public function testExtractShouldReturnFalseWhenAnItemIsNotMatchedByThePredicate(): void
    {
        $this->originalContext->getData()->willReturn('my-data')->shouldBeCalledTimes(2);
        $this->originalContext->getPath()->shouldNotBeCalled();
        /** @noinspection PhpUndefinedMethodInspection */
        ...
        self::assertFalse($this->getAllExtractor()->extract($this->originalContext->reveal()));
    }
     ...
     * @throws ExtractorException
     */
    public function testExtractShouldReturnTrueWhenAllItemsAreMatchedByThePredicate(): void
    {
        $this->originalContext->getData()->willReturn('my-data')->shouldBeCalledTimes(2);
        $this->originalContext->getPath()->shouldNotBeCalled();
        /** @noinspection PhpUndefinedMethodInspection */
