...
final class IsEmptyPredicateTest extends AbstractIntegrationTestCase
{
     ...
     */
    #[CoversNothing]
    public function testCheckIsEmptyPredicate(): void
    {
        ...
        self::assertTrue($predicate->match(new Context(0.0)));
        self::assertTrue($predicate->match(new Context([])));
        self::assertTrue($predicate->match(new Context('0')));

        self::assertFalse($predicate->match(new Context('0.0')));
     ...
     */
    #[CoversNothing]
    public function testCheckIsNotEmptyPredicate(): void
    {
