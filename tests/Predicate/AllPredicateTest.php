...
final class AllPredicateTest extends TestCase
{
    ...
    public function testMatchShouldReturnTrueWhenDataIsAnEmptyArray(): void
    {
        ...
        self::assertTrue($this->getAllPredicate()->match($this->originalContext->reveal()));
    }
     ...
     * @throws ExtractorException
     */
    public function testMatchShouldReturnFalseAsSoonAsPossibleThusWhenAnItemIsNotMatching(): void
    {
        $this->originalContext->getData()->willReturn('my-data-2')->shouldBeCalledTimes(2);
        $this->originalContext->getPath()->shouldNotBeCalled();
        /** @noinspection PhpUndefinedMethodInspection */
        ...
        self::assertFalse($this->getAllPredicate()->match($this->originalContext->reveal()));
    }
     ...
     * @throws ExtractorException
     */
    public function testMatchShouldReturnTrueWhenAllItemsAreMatching(): void
    {
