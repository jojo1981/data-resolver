...
final class SomePredicateTest extends TestCase
{
     ...
     * @throws ExtractorException
     */
    public function testMatchShouldReturnFalseWhenDataIsAnEmptyArray(): void
    {
        ...
        self::assertFalse($this->getSomePredicate()->match($this->originalContext->reveal()));
    }
     ...
     * @throws ExtractorException
     */
    public function testMatchShouldReturnTrueAsSoonAsPossibleThusWhenAnItemIsMatching(): void
    {
        $this->originalContext->getData()->willReturn('my-data-2')->shouldBeCalledTimes(2);
        $this->originalContext->getPath()->shouldNotBeCalled();
        /** @noinspection PhpUndefinedMethodInspection */
        ...
        self::assertTrue($this->getSomePredicate()->match($this->originalContext->reveal()));
    }
     ...
     * @throws ExtractorException
     */
    public function testMatchShouldReturnFalseWhenAllItemsAreNotMatching(): void
    {
