...
final class AndPredicateTest extends TestCase
{
     ...
     */
    public function testMatchShouldReturnFalseBecauseLeftPredicateReturnFalseAndRightPredicateShouldNotBeCalled(): void
    {
        ...
        self::assertFalse($this->getAndPredicate()->match($this->originalContext->reveal()));
    }
     ...
     * @throws ExtractorException
     */
    public function testMatchShouldReturnFalseBecauseLeftPredicateReturnTrueAndRightPredicateReturnFalse(): void
    {
        /** @noinspection PhpUndefinedMethodInspection */
     ...
     * @throws ExtractorException
     */
    public function testMatchShouldReturnTrueBecauseLeftPredicateAndRightPredicateReturnTrue(): void
    {
        /** @noinspection PhpUndefinedMethodInspection */
        $this->originalContext->copy()->willReturn($this->copiedContext)->shouldBeCalledTimes(2);
        $this->leftPredicate->match($this->copiedContext)->willReturn(true)->shouldBeCalledOnce();
        ...
        self::assertTrue($this->getAndPredicate()->match($this->originalContext->reveal()));
    }
